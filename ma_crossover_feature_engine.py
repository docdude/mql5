...
from time_features import get_time_features
from trend_scanning import trend_scanning_labels
from misc import optimize_dtypes, set_resampling_freq
...
class ForexFeatureEngine:
    ...
    def _calculate_volatility_features(self, price_data: pd.DataFrame) -> pd.DataFrame:
        ...
        features = features.assign(
            ...
            bb_percent=bb["BBP_20_2.0_2.0"],
            bb_bandwidth=bb["BBB_20_2.0_2.0"],
        )
        bb_std_val = bb["BBM_20_2.0_2.0"]
